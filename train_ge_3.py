...
result_dir = "training_results_GE_2"
os.makedirs(result_dir, exist_ok=True)
result_file = os.path.join(result_dir, "training_results_GE_2.txt")
...
model_save_path = os.path.join(script_dir, 'trained_model_GE_2.pth')
