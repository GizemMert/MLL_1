...
class VAE_GE(nn.Module):
    def __init__(self, latent_dim=50):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.Conv1d(64, 256, kernel_size=3, stride=2),
            nn.BatchNorm1d(256),
            nn.ReLU(),
            ...
            nn.Conv1d(512, 250, kernel_size=3, stride=2),
            nn.BatchNorm1d(250),
            nn.ReLU(),
            # nn.MaxPool1d(3, stride=3),
            nn.Conv1d(250,100,kernel_size=3, stride=2),
            nn.BatchNorm1d(100),
            nn.ReLU(),
            # nn.MaxPool1d(3, stride=3),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose1d(100, 250, kernel_size=3, stride=3, padding=2, output_padding=2),
            nn.ReLU(),
            nn.ConvTranspose1d(250, 512, kernel_size=3, stride=3, padding=2, output_padding=2),
            nn.ReLU(),
