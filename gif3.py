...
umap_dir = 'umap_trajectory_myeloblast_nsegmented_tresh_09'
...
interpolate_gif_gpr(model_1, "all_myelo_segment", random_myeloblast_point,
                    random_neutrophil_seg_point, steps=100, grid_size=(10, 10))

# SEQUENCE DECODING and GENE EXPRESSED DETECTION
interpolated_points = torch.load('interpolation_2_latent_points.pt')
