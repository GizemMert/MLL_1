...
def interpolate_gif_with_gpr(model, filename, latent_points, n=400, grid_size=(20, 20)):
    model.eval()
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
...
interpolate_gif_with_gpr(model, "vae_interpolation_grid_SLERP", latent_points, n=400, grid_size=(20, 20))
