...
interpolate_gif_gpr(model_1, "vae_interpolation_gpr_band_segmented", random_neutrophil_banded_point, random_neutrophil_seg_point, steps=100, grid_size=(10, 10))

#SEQUENCE DECODING and GENE EXPRESSED DETECTION
adata = anndata.read_h5ad('s_data_feature_liver_lung.h5ad')
interpolated_points = torch.load('interpolation_band_segmented_latent_points.pt')
...
driving_gene_names = ["MPO", "ELANE", "CD16", "CD11b", "CD18", "CXCR1", "CXCR2", "CXCR4", "CD62", "PU1", "CEBPA",
                      "CEBPE", "GFI1", "LEF1", "NE", "CEBP", "GCSFR", "CSFR","FOSl1", "FOSL2", "JUNB", "BCL6",
                      "KLF6", "IRF1", "RUNX1", "CEBPD", "PU2", "NFIL3", "MAX", "MLX", "XPB1", "ICAM1", "CD62L",
                      "BMAL1", "CXCL2", "P38", "MK2", "HIF1A"]
