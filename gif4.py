...
def compute_geodesic_path(start_latent, end_latent, n_points=100):
...
def interpolate_gif_pdf(filename, start_latent, end_latent, steps=100,  grid_size=(10, 10)):
...
interpolate_gif_pdf("vae_interpolation_grid_pdf", random_myeloblast_point, random_neutrophil_banded_point, steps=100, grid_size=(10, 10))
