...
model = VariationalAutoencodermodel(latent_dim=30, num_classes=13)
model_name = 'AE-CFE-'
...
umap_dir = 'umap_figures_vae_cls'
if not os.path.exists(umap_dir):
    os.makedirs(umap_dir)

latent_dir = 'latent_data_vae_cls'
if not os.path.exists(latent_dir):
    os.makedirs(latent_dir)

label_dir = 'label_data_vae_cls'
if not os.path.exists(label_dir):
    os.makedirs(label_dir)

result_dir = "training_results_vae_cls"
os.makedirs(result_dir, exist_ok=True)
result_file = os.path.join(result_dir, "training_results_vae_cls.txt")

save_img_dir = "masked_images_vae_cls"
if not os.path.exists(save_img_dir):
    os.makedirs(save_img_dir)

save_mask_dir = "masks_vae_cls"
...
for epoch in range(epochs):
    ...
    print(
        "epoch : {}/{}, loss = {:.6f}, feat_loss = {:.6f}, imrec_loss = {:.6f}, kl_div = {:.6f}, Cls_F1_Score = {:.6f}".format
    ...
    for i in range(30):
        ...
        if epoch % 10 == 0:
            file_name = "reconsructed-images_vae_cls/"
...
model_save_path = os.path.join(script_dir, 'trained_model_vae_cls.pth')
